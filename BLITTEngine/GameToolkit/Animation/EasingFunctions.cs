...
namespace BLITTEngine.GameToolkit.Animation
{
    public static class EasingFunctions
    {
        ...
        public static float SineIn(float value) => Calc.Sin(value * Calc.PI_OVER2 - Calc.PI_OVER2) + 1;
        public static float SineOut(float value) => Calc.Sin(value * Calc.PI_OVER2);
        public static float SineInOut(float value) => (Calc.Sin(value * Calc.PI - Calc.PI_OVER2) + 1)/2;

        public static float ExponentialIn(float value) => Calc.Pow(2, 10*(value - 1));
        ...
        public static float CircleIn(float value) => -(Calc.Sqrt(1 - value * value) - 1);
        public static float CircleOut(float value) => Calc.Sqrt(1 - (value - 1) * (value - 1));
        public static float CircleInOut(float value) => value <= .5 ? (Calc.Sqrt(1 - value * value * 4) - 1) / -2 : (Calc.Sqrt(1 - (value * 2 - 2) * (value * 2 - 2)) + 1) / 2;
        ...
        public static float ElasticIn(float value)
        {
            ...
            return (float) (e * Calc.Sin((Calc.PI_OVER2 + Calc.TWO_PI * oscillations)*value));
        }
        ...
        public static float BackIn(float value)
        {
            ...
            return (float) (Math.Pow(value, 3) - value*amplitude*Math.Sin(value*Calc.PI));
        }
